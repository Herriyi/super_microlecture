...
<section class="container clearfix">
  <div id="me" class="me clearfix">
    <div class="main">
      ...
      <div class="mod">
        ...
        <div class="tab-bar">
           <ul class="clearfix">
               <li class="active"><a href="turnToHomePage.htm">课程推荐</a></li>
  ...
  <div class="mod">    
		...
		<c:forEach items="${ucList}" var="ucList">
		
    		<div class="course-row" id="course-row-4612">
    			<div class="imageblock">
    			
      				<div class="imageblock-image"><a href="courseDetailPage.htm?courseId=${ucList.course.courseId}"><img src="/pic/h2.jpg"></a></div>
      					<div class="imageblock-content">
        					<div class="title">
         						 <a href="courseDetailPage.htm?courseId=${ucList.course.courseId}">${ucList.course.courseTitle}</a>
        					</div>
        					<div class="summary">${ucList.course.courseIntro}</div>
        					<div class="metas">
         							 By<a href="goPersonnal.htm?userId=${ucList.user.userId}" class="show-user-card" title="${ucList.user.nickname}">${ucList.user.nickname}</a>
          								&nbsp;&nbsp;浏览量：<a href="">${ucList.course.scanNum}</a>
        					</div>
      					</div>
    			</div>
  			</div>
...
<div class="main-side">
  ...
  <div class="btn-bar">
    <div class="day">${yue}.${ri}<br /><strong>周${xingqiji}</strong></div>
    <div class="checkin-text">每日一战</div>
    <a href="challenge.htm" class="btn btn-small checkin-btn"><strong>战</strong></a>
  ...
  <ul id="recommend-daren-list">
    ...
    <div class="side">
      ...
      <div class="avatar-mod clearfix">
        ...
        <div class="infos">
          <div class="nickname"><a>${userName}</a></div>
          <div class="icons">
