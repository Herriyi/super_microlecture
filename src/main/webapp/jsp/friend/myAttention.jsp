        	...
        	<div class="imageblock-image"><a href="" class="show-user-card"><img src="<c:url value="${list.userByAttentionedUserId.headImage.imageMid}"/>"></a>
         	...
         	<div class="imageblock-content">
                ...
                <p>
                	...
                	<span class="fsm"><a href="" class="show-user-card " data-uid="1359470" >${list.userByAttentionedUserId.nickname}</a></span>
            	</p>
                <p class="gray">${list.userByAttentionedUserId.signature}</p>
          	</div>
        	</div>
