...
<script type="text/javascript">
	$(function(){
		...
		$("#fabu").click(function(){
			...
			$("#tab").children("#a").children("tr").each(function(){
				var sta=$(this).children("td:eq(6)").html();				               
				//alert(sta);
             if(sta=="申请中"){
                   alert("还有课时没有通过，不能发布！");
                   return false;
						...
						<table class="table table-striped sortable" id="tab" >
							...
							<c:forEach items="${course.courses}" var="courseList">
								<tr>
									...
									<td style="text-align:center;">${courseList.courseState}</td>
