package org.sicdlab.microlecture.business.register.controller;
...
import org.sicdlab.microlecture.business.register.service.SendMailService;
...
public class UserRegisterController {
	...
	public  ModelAndView userRegister(HttpServletRequest request ,HttpServletResponse response) throws Exception{
		...
		String imageLage="/pic/imagehead/default1.jpg";
		String imageMid="/pic/imagehead/default2.jpg";
		String imageSmall="/pic/imagehead/default3.jpg";
		
		
		HeadImage headImage=new HeadImage();
		
		headImage.setImageId(UUIDGenerator.randomUUID());
		headImage.setImageLage(imageLage);
		...
		String url="尊敬的"+user.getNickname()+"您好，点击链接激活您的微课程账号<br><a href='http://localhost:8888/microlecture/verifyEmail.htm?userid="+user.getUserId()+"'>激活</a><br>";
		try {
			email.sendEmail(
					"2424208347@qq.com",
					"微课程",
