...
<div class="mod">
  ...
  <ul>
    <li class="on"><a href="/account/">个人资料</a></li>
    <li><a href="goaccountavatar.htm">更新头像</a></li>
    <li><a href="/account/password">修改密码</a></li>
    <li><a href="/account/email">邮箱设置</a></li>
    <li><a href="/account/share">同步分享</a></li>
  </ul>
</div>
  ...
  <form id="account-profile-form" class="form-horizontal" method="post" action="accountupdate.htm">
    ...
    <div class="control-group" >
      ...
      <div class="controls"><input type="text" id="userprofile_city" name="city"class="span2"/></div>
    </div>

    <div class="control-group">
      <label class="control-label required" for="userprofile_signature" >签名档:</label>
      <div class="controls">
        
        <input type="text" id="userprofile_signature" name="userprofile_signature" class="span7" maxlength="45"  />
        <span class="help-block"></span>
      </div>
    </div>

    <div class="control-group">
            <label class="control-label required" for="userprofile_about">自我介绍:</label>
            <div class="controls">
            
            <textarea id="userprofile_about" name="about" class="span7" rows="3"></textarea></div>
    </div>
    ...
    <div class="side">
      ...
      <div class="menu-mod clearfix">
        <ul class="menus">
          <li ><a href="goaccount.htm"><i class="feature-icon feature-icon-home"></i>我的首页</a></li>
          <li ><a href="feed.htm"><i class="feature-icon feature-icon-feed"></i>好友动态<span id="feed-counter" class="counter"></span></a></li>
          <li ><a href="learn.htm"><i class="feature-icon feature-icon-learn"></i>学习计划</a></li>
          <li ><a href="teach.htm"><i class="feature-icon feature-icon-teach"></i>创建课程</a></li>
          ...
          <li ><a href="discussion.htm"><i class="feature-icon feature-icon-group"></i>小组<span id="group-counter" class="counter"></span></a></li>
        ...
        <ul class="menus">
          ...
          <li class="active"><a href="/account/"><i class="feature-icon feature-icon-setting"></i>账户设置</a></li>
        </ul>
      </div>
